...
class SponsorController extends AbstractController
{
    ...
    public function indexMobile(SponsorRepository $userRepository, EntityManagerInterface $entityManager, SerializerInterface $serializer): JsonResponse
    {
        $sponsors = $userRepository->findAll();
        $serializedUsers = $serializer->serialize($sponsors, 'json', ['groups' => 'sponsors']);
