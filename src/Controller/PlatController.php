...
//Tri_Back
    ...
    public function TriPBackA(PlatRepository $repository)
    {
    ...
    public function TriPBackD(PlatRepository $repository)
    {
    ...
    public function TriNBackA(PlatRepository $repository)
    {
    ...
    public function TriNBackD(PlatRepository $repository)
    {
    ...
    public function TriCBackA(PlatRepository $repository)
    {
    ...
    public function TriCBackD(PlatRepository $repository)
    {
...
//Rercherche front
    ...
    public function searchAjaxFront(Request $request,PlatRepository $repo)
    {
        // Récupérez le paramètre de recherche depuis la requête
        $query = $request->query->get('q');

        // Récupérez les plats correspondants depuis la base de données
        $plats = $repo->findPlatByNameFront($query);
...
//WorkShopJson
    ...
    public function AddPlatsJson(SerializerInterface $normalizer,Request $request,ManagerRegistry $mg)
    {
          $em = $mg->getManager();
