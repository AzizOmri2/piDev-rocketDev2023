...
class ResetPasswordController extends AbstractController
{
    ...
    #[Route('/oublipass', name:'forgotten_password')]
    public function forgottenPassword(
        Request $request, UserRepository $userRepository, \Swift_Mailer $mailer, TokenGeneratorInterface $tokenGenerator,EntityManagerInterface $doctrine
    ): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
           ...
           /* try {
            ...
            $message = (new \Swift_Message('Mot de password oublié'))
                ->setFrom('maaha.messaoud@esprit.tn')
                ->setTo($donnees)
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, \Swift_Mailer $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('maaha.messaoud@esprit.tn', 'EnergyBox BOT'))
            ->to($user->getEmail())
