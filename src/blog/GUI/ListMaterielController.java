...
ResultSet rs = pstmt.executeQuery();
            ...
            p.setId(rs.getInt("id"));//or rst.getInt(1)
                     p.setNom_materiel(rs.getString("nom_materiel"));//or rst.getInt(1)
                      p.setReference_materiel(rs.getString("reference_materiel"));//or rst.getInt(1)
                       p.setDate_maintenance((rs.getString("date_maintenance_materiel")));//or rst.getInt(1)
        ...
        maintM.setCellValueFactory(new PropertyValueFactory<Materiel, String>("date_maintenance_materiel"));
