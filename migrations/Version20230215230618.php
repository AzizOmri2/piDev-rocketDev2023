 ...
 */
final class Version20230215230618 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE abonnement (id INT AUTO_INCREMENT NOT NULL, pack_id INT NOT NULL, duree_abonnement VARCHAR(255) NOT NULL, date_achat DATE NOT NULL, date_fin DATE NOT NULL, etat_abonnement VARCHAR(255) NOT NULL, INDEX IDX_351268BB1919B217 (pack_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pack (id INT AUTO_INCREMENT NOT NULL, type_pack VARCHAR(255) NOT NULL, offre_pack DOUBLE PRECISION DEFAULT NULL, montant_pack DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE planning (id INT AUTO_INCREMENT NOT NULL, cours_id INT NOT NULL, date_planning DATE NOT NULL, jour_planning VARCHAR(255) NOT NULL, heure_planning INT NOT NULL, INDEX IDX_D499BFF67ECF78B0 (cours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
