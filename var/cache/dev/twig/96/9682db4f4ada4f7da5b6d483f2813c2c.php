...
class __TwigTemplate_aeaf8d31a3ec44dbe05f2b5d65976713 extends Template
{
    private $source;
    private $macros = [];
                                            ...
                                            <form action=\"\" method=\"post\" enctype=\"multipart/form-data\" class=\"form-horizontal\">
                                                <div class=\"row form-group\">
                                                    ...
                                                    <div class=\"col-12 col-md-9\">
                                                        <input type=\"texte\" name=\"nomActivite\" placeholder=\"Nom Activité\" class=\"form-control\">
                                                    </div>
                                                </div>
                                                <div class=\"row form-group\">
                                                    <div class=\"col col-md-3\">
                                                    ...
                                                    <div class=\"col-12 col-md-9\">
                                                        <input type=\"texte\" name=\"dureeActivite\" placeholder=\"Durée Activité\" class=\"form-control\">
                                                        <small class=\"form-text text-muted\">Veuillez saisir la durée de l'activité en minutes</small>
                                                    </div>
                                                </div>
                                                <div class=\"row form-group\">
                                                    <div class=\"col col-md-3\">
                                                        <label for=\"select\" class=\" form-control-label\">Tenue Recommendée</label>
                                                    </div>
                                                    <div class=\"col-12 col-md-9\">
                                                ...
                                                <div class=\"row form-group\">
                                                    <div class=\"col col-md-3\">
                                                        <label for=\"select\" class=\" form-control-label\">Select Difficulté</label>
                                                    </div>
                                                    <div class=\"col-12 col-md-9\">
